	...
	return (
		<SongCardWrapper>
			<div className="thumbnail-title-container">
				<div style={{ backgroundImage: `url(${thumbnails[1].url})` }} className='album-cover'>
			...
			<div className='play-symbol-container'>
				<MdPlayCircleOutline onClick={() => dispatch({type: PLAYER_ACTIONS.SET_CURRENT_SONG, payload: videoId })} className="play-btn" />
			</div>
		</SongCardWrapper>
	);
}
